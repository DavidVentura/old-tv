...
if __name__ == '__main__':
    ...
    command = command + fc + " -map '[v]' -map '[a]' -c:v libx264 -c:a libmp3lame -ac 1 -ar 44100 -preset:v veryfast -profile:v baseline -movflags +faststart -g 12 -r 24 -y channel%d.mp4" % channel
    print(command)
    # pprint(index())
